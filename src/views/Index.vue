            ...
            <section class="faq" id="faq">
                ...
                <div class="faq-list">
                    ...
                    <details>
                        ...
                        <p>
                            Проверьте прошла ли оплата. Если оплата прошла и
                            заказ был успешно офорлмен, то письмо придет в
                            ближайшее время. Если письмо все же не пришло это
                            означает, что система по какой-то причине не увидела
                            поступившие деньги или почтовый сервис дал сбой. В
                            таком случае свяжитесь с нами (контакты указаны
                            внизу страницы) для уточнения информации.
                        </p>
                    </details>
                    <details>
                        <summary>
