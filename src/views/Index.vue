	...
	<main class="main">
		<section class="hero" id="hero">
			<div class="container">
				<div class="hero__inner">
					...
					<h1>Экскурсии по Москве</h1>
					<p class="subtitle">
						Откройте для себя Столицу- на автобусе, теплоходе и пешком:<br />
		...
		<div class="container main__inner">
				...
				<div>
					...
					<div class="list">
						<div class="row">
							...
							<p class="text">
								Команда экскурсоводов Московского экскурсионного бюро - это
								группа профессионалов, которые готовы провести гостей по самым
								интересным местам и достопримечательностям города.
							</p>
						</div>
						<div class="row">
							<div class="num">02</div>
							<p class="text">
								Наша команда состоит из опытных и увлеченных людей, которые
								любят свой город и готовы поделиться своими знаниями и опытом с
								гостями. Мы предлагаем групповые экскурсии, а также
						...
						<div class="row">
							...
							<p class="text">
								Мы работаем с различными видами транспорта, включая речной
								транспорт и автобусы, чтобы обеспечить нашим гостям максимальный
								комфорт и удобство. Наша цель - сделать экскурсии по Москве
								незабываемыми и интересными для всех наших гостей.
							</p>
						</div>
						<div class="row">
							<div class="num">04</div>
							<div class="about-flags">
								<p class="text">Мы проводим экскурсии на следующих языках:</p>
								<div class="flags">
									<img
			...
			<section class="excursions" id="excursions">
				...
				<div class="grid">
					<p class="red-warning big" v-if="excursions.length === 0">
						Ошибка загрузки списка экскурсий, попробуйте перезагрузить сайт
					</p>
					<Excursion
						v-for="excursionObject in excursions"
						:excursionObject="excursionObject"
						:key="excursionObject.excursion.id"
					></Excursion>
				</div>
			</section>
			...
			<section class="faq" id="faq">
				...
				<div class="faq-list">
					<details>
						...
						<p>
							Вы можете оформить билеты онлайн, для этого выберите желаемую
							экскурсию, нажмите кнопку "Заказать" и следуйте дальнейшим
							инструкциям. Также вы можете оформить заказ, написав нам в
							WhatsApp
						</p>
					</details>
					<details>
						<summary>Нет экскурсии, которую я хочу. Что делать?</summary>
						<p>
							Мы постоянно работаем над улучшением и расширением списка
							экскурсий, однако бывает такое, что желаемой экскурсии нет. В
							таком случае вы можете уточнить дополнительную информацию по
							телефону или заказать индивидуальную экскурсию
						</p>
					</details>
					<details>
						<summary>Я купил билеты, что дальше?</summary>
						<p>
							Вся дополнительная информация придет вам на почту, которую вы
							указывали при заказе. При возникновении дополнительных вопросов
							пишите или звоните нам!
						</p>
					</details>
					<details>
						<summary>Не пришло письмо на почту</summary>
						<p>
							Проверьте прошла ли оплата. Если оплата прошла и заказ был успешно
							офорлмен, то письмо придет в ближайшее время. Если письмо все же
							не пришло это означает, что система по какой-то причине не увидела
							поступившие деньги или почтовый сервис дал сбой. В таком случае
							свяжитесь с нами (контакты указаны внизу страницы) для уточнения
							информации.
						</p>
					</details>
					<details>
						<summary>Что делать, если я опоздал на экскурсию?</summary>
						<p>
							Если вы опоздали на экскурсию, то свяжитесь с вашим гидом или
							организатором экскурсии и сообщите о своей задержке. Возможно, вам
							предложат присоединиться к группе позже
						</p>
					</details>
				</div>
			</section>
			<section class="special" id="special">
				...
				<p>
					Компания предлагает услуги проведения индивидуальных экскурсий, состав
					и тематика которых определяются на основе технического задания
					заказчика. Для обсуждения деталей и оформления заказа вы можете
					связаться с нами по электронной почте или другим удобным для вас
					способом.
				</p>
				<div class="centered">
					<button
